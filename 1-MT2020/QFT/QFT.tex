...
\begin{document}
	...
	\paragraph{\underline{Infrared (IR) Divergence}} (Large distance, low energy scale): \[
	...
	\]
	\paragraph{\underline{Ultraviolet (UV) Divergence}} (High energy, short distance) This is due to large momenta as shown above. The cure is to introduce a UV cut-off $\Lambda \ll M \ll L^{-1}$. Define
	\[
